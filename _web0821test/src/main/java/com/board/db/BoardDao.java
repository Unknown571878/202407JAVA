...
public class BoardDao {
	...
	public boolean deleteAll(int usernum) {
		try {
			session.update("BoardMapper.deleteAll", usernum);
		} catch (Exception e) {
			System.out.println("여기!!!");
			//e.printStackTrace();
			return true;
	...
	public int userPost(BoardDto dto) {
		return session.selectOne("BoardMapper.userPost", dto);
	}
